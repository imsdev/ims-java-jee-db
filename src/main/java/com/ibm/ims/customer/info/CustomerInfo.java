package com.ibm.ims.customer.info;

import java.util.ArrayList;
import java.util.List;

import com.ibm.ims.policy.info.AutoPolicy;
import com.ibm.ims.policy.info.HousePolicy;
...
public class CustomerInfo {
	...
	public void addHousePolicy(HousePolicy housePolicy) {
		if(housePolicies == null) {
			housePolicies = new ArrayList<>();
		}
